...
@dg.asset(
    ...
    description="Fetch latest month industrial value added data from national statistics bureau",
)
def industrial_value_added(context: dg.AssetExecutionContext) -> dg.MaterializeResult:
    """Fetch industrial value added data from national statistics bureau.

    Industrial value added is a key indicator of industrial production activity
    and an important component of national economic accounting.
    ...
    """
    context.log.info("Fetching industrial value added data...")
